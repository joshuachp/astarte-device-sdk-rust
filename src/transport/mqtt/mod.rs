    ...
    async fn send(
        ...
        self.apply_timeout(
            sender
                ...
                .map(|res| res.wrap_err_msg(MqttError::Publish, "while sending")),
        )
        .await
    }
    ...
    async fn add_interface(
        ...
        self.apply_timeout(
            sender
                ...
                .map(|res| res.wrap_err_msg(MqttError::Publish, "send introspection")),
        )
        .await
        .map_kind(ErrorKind::Mqtt)?
        .await
    ...
    async fn remove_interface(
        ...
        self.apply_timeout(
            sender
                .client
                .send_introspection(sender.id.as_ref(), introspection)
                .map(|res| res.wrap_err_msg(MqttError::Publish, "while sending introspection")),
        )
        .await
        .map_kind(ErrorKind::Mqtt)?
        .await
    ...
    async fn remove_interfaces(
        ...
        self.apply_timeout(
            sender
                .client
                .send_introspection(sender.id.as_ref(), introspection)
                .map(|res| res.wrap_err_msg(MqttError::Publish, "while sendind introspection")),
        )
        .await
        .map_kind(ErrorKind::Mqtt)?
        .await
