...
- **Message Hub**: multiple applications or sensors connect to the Hub that acts as a single device
  to Astarte
...
If you follow the guide you'll have an Astarte instance must be accessible from the Message Hub
serve, and all the keys necessary to register the Message Hub server as a new device.
...
they are on the same and secure LAN network. The only client's requirement for connect to the
